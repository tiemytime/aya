...
class NewsController {
  ...
  static COUNTRY_COORDINATES = {
    ...
    'Armenia': { lat: 40.069099, lng: 45.038189, code: 'AM' },
    'Australia': { lat: -25.274398, lng: 133.775136, code: 'AU' },
    'Austria': { lat: 47.516231, lng: 14.550072, code: 'AT' },
    'Azerbaijan': { lat: 40.143105, lng: 47.576927, code: 'AZ' },
    'Bangladesh': { lat: 23.684994, lng: 90.356331, code: 'BD' },
    'Belarus': { lat: 53.709807, lng: 27.953389, code: 'BY' },
    'Belgium': { lat: 50.503887, lng: 4.469936, code: 'BE' },
    'Bolivia': { lat: -16.290154, lng: -63.588653, code: 'BO' },
    'Brazil': { lat: -14.235004, lng: -51.92528, code: 'BR' },
    'Bulgaria': { lat: 42.733883, lng: 25.48583, code: 'BG' },
    'Cambodia': { lat: 12.565679, lng: 104.990963, code: 'KH' },
    'Canada': { lat: 56.130366, lng: -106.346771, code: 'CA' },
    'Chile': { lat: -35.675147, lng: -71.542969, code: 'CL' },
    'China': { lat: 35.86166, lng: 104.195397, code: 'CN' },
    'Colombia': { lat: 4.570868, lng: -74.297333, code: 'CO' },
    'Croatia': { lat: 45.1, lng: 15.2, code: 'HR' },
    'Czech Republic': { lat: 49.75, lng: 15.5, code: 'CZ' },
    'Denmark': { lat: 56.26392, lng: 9.501785, code: 'DK' },
    'Ecuador': { lat: -1.831239, lng: -78.183406, code: 'EC' },
    'Egypt': { lat: 26.820553, lng: 30.802498, code: 'EG' },
    'Estonia': { lat: 58.595272, lng: 25.013607, code: 'EE' },
    'Ethiopia': { lat: 9.145, lng: 40.489673, code: 'ET' },
    'Finland': { lat: 61.92411, lng: 25.748151, code: 'FI' },
    'France': { lat: 46.227638, lng: 2.213749, code: 'FR' },
    'Georgia': { lat: 42.315407, lng: 43.356892, code: 'GE' },
    'Germany': { lat: 51.165691, lng: 10.451526, code: 'DE' },
    'Ghana': { lat: 7.946527, lng: -1.023194, code: 'GH' },
    'Greece': { lat: 39.074208, lng: 21.824312, code: 'GR' },
    'Hungary': { lat: 47.162494, lng: 19.503304, code: 'HU' },
    'Iceland': { lat: 64.963051, lng: -19.020835, code: 'IS' },
    ...
    'Ireland': { lat: 53.41291, lng: -8.24389, code: 'IE' },
    ...
    'Jordan': { lat: 30.585164, lng: 36.238414, code: 'JO' },
    'Kazakhstan': { lat: 48.019573, lng: 66.923684, code: 'KZ' },
    'Kenya': { lat: -0.023559, lng: 37.906193, code: 'KE' },
    'Latvia': { lat: 56.879635, lng: 24.603189, code: 'LV' },
    'Lebanon': { lat: 33.854721, lng: 35.862285, code: 'LB' },
    'Lithuania': { lat: 55.169438, lng: 23.881275, code: 'LT' },
    'Malaysia': { lat: 4.210484, lng: 101.975766, code: 'MY' },
    'Mexico': { lat: 23.634501, lng: -102.552784, code: 'MX' },
    'Morocco': { lat: 31.791702, lng: -7.09262, code: 'MA' },
    'Netherlands': { lat: 52.132633, lng: 5.291266, code: 'NL' },
    'New Zealand': { lat: -40.900557, lng: 174.885971, code: 'NZ' },
    'Nigeria': { lat: 9.081999, lng: 8.675277, code: 'NG' },
    'North Korea': { lat: 40.339852, lng: 127.510093, code: 'KP' },
    'Norway': { lat: 60.472024, lng: 8.468946, code: 'NO' },
    'Pakistan': { lat: 30.375321, lng: 69.345116, code: 'PK' },
    'Peru': { lat: -9.189967, lng: -75.015152, code: 'PE' },
    'Philippines': { lat: 12.879721, lng: 121.774017, code: 'PH' },
    'Poland': { lat: 51.919438, lng: 19.145136, code: 'PL' },
    'Portugal': { lat: 39.399872, lng: -8.224454, code: 'PT' },
    'Romania': { lat: 45.943161, lng: 24.96676, code: 'RO' },
    'Russia': { lat: 61.52401, lng: 105.318756, code: 'RU' },
    'Saudi Arabia': { lat: 23.885942, lng: 45.079162, code: 'SA' },
    'Serbia': { lat: 44.016521, lng: 21.005859, code: 'RS' },
    'Singapore': { lat: 1.352083, lng: 103.819836, code: 'SG' },
    'Slovakia': { lat: 48.669026, lng: 19.699024, code: 'SK' },
    'Slovenia': { lat: 46.151241, lng: 14.995463, code: 'SI' },
    ...
    'Sri Lanka': { lat: 7.873054, lng: 80.771797, code: 'LK' },
    'Sweden': { lat: 60.128161, lng: 18.643501, code: 'SE' },
    'Switzerland': { lat: 46.818188, lng: 8.227512, code: 'CH' },
    'Syria': { lat: 34.802075, lng: 38.996815, code: 'SY' },
    'Taiwan': { lat: 23.69781, lng: 120.960515, code: 'TW' },
    'Thailand': { lat: 15.870032, lng: 100.992541, code: 'TH' },
    'Tunisia': { lat: 33.886917, lng: 9.537499, code: 'TN' },
    'Turkey': { lat: 38.963745, lng: 35.243322, code: 'TR' },
    'Ukraine': { lat: 48.379433, lng: 31.16558, code: 'UA' },
    'United Arab Emirates': { lat: 23.424076, lng: 53.847818, code: 'AE' },
    'United Kingdom': { lat: 55.378051, lng: -3.435973, code: 'GB' },
    'United States': { lat: 37.09024, lng: -95.712891, code: 'US' },
    'Uruguay': { lat: -32.522779, lng: -55.765835, code: 'UY' },
    'Venezuela': { lat: 6.42375, lng: -66.58973, code: 'VE' },
    'Vietnam': { lat: 14.058324, lng: 108.277199, code: 'VN' }
  };
